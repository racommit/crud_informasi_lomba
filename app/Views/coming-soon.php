...
<head>
    <title> Coming Soon | Sistem Informasi Lomba</title>
</head>
<?php
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> Form Lomba Yang Mendatang</h5>
            ...
            <div class="modal-body">
                <form action="<?= base_url('tambahLomba') ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tanggal" min="<?= date('Y-m-d'); ?>" name="tanggal" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('editLomba') ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="tanggal">Tanggal</label>
                        <input type="date" class="form-control" id="tanggal2" name="tanggal2" min="<?= date('Y-m-d'); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <strong class="card-title">Lomba Mendatang</strong>
                        <?php if($Role == '1') :?>
